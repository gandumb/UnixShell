...
string trim(const string& str) {
    ...
    return str.substr(first, (last - first + 1)); //Shave off all leading and traliing whitespace
}
...
//for converting vector to character array use __string_vector__.c_str()
